...
$config['mongo_db']['default']['database'] = 'leatherr_staging';
...
$config['mongo_db']['default']['database'] = 'retv';

$config['mongo_db']['default']['username'] = 'retv';
$config['mongo_db']['default']['password'] = 'retv@2016';
